    ...
    <div>
        ...
        <el-dialog title="用户信息" :visible.sync="dialogFormVisible" width="30%" >
            <el-form label-width="80px" size="small">
                <el-form-item style="width: 205px" label="姓名">
                    <el-input v-model="form.name" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item style="width: 205px" label="所属专业">
                    <el-input v-model="form.major" autocomplete="off" ></el-input>
                </el-form-item>
                <el-form-item style="width: 205px" label="联系方式">
                    <el-input v-model="form.phone" autocomplete="off" type="number"></el-input>
                </el-form-item>
                <el-form-item style="width: 205px" label="QQ号码">
                    <el-input v-model="form.qq" autocomplete="off" type="number"></el-input>
                </el-form-item>
...
<script>
    export default {
        ...
        methods:{
            ...
            del(id){
                this.request.delete("http://localhost:9090/teacher/"+id).then(res => {
                    if (res) {
